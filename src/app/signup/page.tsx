      ...
      <div className="flex-1 flex flex-col w-full max-w-md mx-auto">
        ...
        <div className="mt-auto flex flex-col items-center gap-8">
          ...
          <p className="text-center text-[13px] text-zinc-500 max-w-xs leading-relaxed">
            By continuing you agree to Pipel's <a href="#" className="font-semibold text-zinc-800 hover:text-black transition-colors">Terms of Service</a> and <a href="#" className="font-semibold text-zinc-800 hover:text-black transition-colors">Privacy Policy</a>
          </p>
